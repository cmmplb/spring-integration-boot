package io.github.cmmplb.velocity.congtroller;
...
public class VelocityController {
    ...
    public Result<String> velocity() {
        ...
        p.setProperty(Velocity.FILE_RESOURCE_LOADER_PATH, "/Users/penglibo/Cmmplb/Project/Cmmplb/Gitee/spring-integration-boot/05.spring-boot-velocity/src/main/resources/templates");
        ...
        return ResultUtil.success(writer.toString());
    }
