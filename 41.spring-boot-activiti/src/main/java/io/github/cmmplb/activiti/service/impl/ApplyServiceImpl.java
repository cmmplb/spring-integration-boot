...
import io.github.cmmplb.activiti.dao.ApplyMapper;
...
import io.github.cmmplb.activiti.vo.LeaveApplyDetailsVO;
...
public class ApplyServiceImpl extends ServiceImpl<ApplyMapper, Apply> implements ApplyService {
    ...
    public boolean cancelApply(Long id) {
        ...
        if (null == apply) {
            throw new CustomException("申请信息已删除");
        }
    ...
    public boolean deleteById(Long id) {
        ...
        if (apply.getType().equals(GlobalConstant.NUM_ONE)) {
            ...
            if (null == leaveApply) {
                throw new CustomException("请假信息已删除");
            }
            ...
            if (null == evectionApply) {
                throw new CustomException("出差信息已删除");
            }
