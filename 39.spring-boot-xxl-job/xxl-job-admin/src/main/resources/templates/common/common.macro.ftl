<#macro commonStyle>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, userDetails-scalable=no" name="viewport">
    <!--  Bootstrap  -->
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<#if Request["XXL_JOB_LOGIN_IDENTITY"].role == 1>
                    ...
                    <li class="nav-click <#if pageName == "userDetails">active</#if>" ><a href="${request.contextPath}/userDetails"><i class="fa fa-circle-o text-purple"></i><span>${I18n.user_manage}</span></a></li>
				</#if>
		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="control-sidebar-home-tab">
				...
				<ul class="control-sidebar-menu">
					...
					<li>
						<a href="javascript::;"> 
							<i class="menu-icon fa fa-userDetails bg-yellow"></i>
							<div class="menu-info">
