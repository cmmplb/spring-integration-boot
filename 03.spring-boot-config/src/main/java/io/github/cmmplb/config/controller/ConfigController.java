package io.github.cmmplb.config.controller;

import io.github.cmmplb.config.beans.*;
...
public class ConfigController {
    ...
    public Result<String> getConfigCustomXml() throws Exception {
        ...
        br.close();
        // XML转为JAVA对象
        ConfigCustomXml configCustomXml = (ConfigCustomXml) XmlUtil.xmlStrToObject(ConfigCustomXml.class, buffer.toString());
