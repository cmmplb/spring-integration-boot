package io.github.cmmplb.security.config;

import io.github.cmmplb.security.filter.SmsCodeFilter;
import io.github.cmmplb.security.filter.ValidateCodeFilter;
import io.github.cmmplb.security.handler.AccessDeniedHandler;
...
import io.github.cmmplb.security.handler.LogoutSuccessHandler;
import io.github.cmmplb.security.service.UserService;
import io.github.cmmplb.security.sms.SmsAuthenticationConfig;
 ...
 * see{@link io.github.cmmplb.security.controller.AnnotationController}
 * @since jdk 1.8
...
public class WebSecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable() // 关闭csrf跨域检查
                ...
                // .addFilterAfter(new SmsCodeAuthenticationFilter(http), UsernamePasswordAuthenticationFilter.class) // 添加短信认证在之后 - 这个配置有问题, 然后在上面apply了io.github.cmmplb.security.config.WebSecurityConfigurer.authenticationConfig
                ...
                .expiredSessionStrategy(new io.github.cmmplb.security.handler.SessionExpiredHandler())
        ;
