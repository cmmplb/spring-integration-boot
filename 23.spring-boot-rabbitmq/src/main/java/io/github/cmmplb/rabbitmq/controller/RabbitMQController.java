...
public class RabbitMQController {
    ...
    public void send2DirectQueue() {
        ...
        producerService.send2DirectQueue(RabbitMqConstant.ONE_DIRECT_ROUTING_KEY, message);
        producerService.send2DirectQueue(RabbitMqConstant.TWO_DIRECT_ROUTING_KEY, message);
        producerService.send2DirectQueue(RabbitMqConstant.THREE_DIRECT_ROUTING_KEY, message);
    }
